...
const Chartii = () => {
  ...
  const randomData = Array.from({ length: 24 }, () => Math.floor(Math.random() * 5000) + 2000);
    ...
    datasets: [
      {
        ...
        data: randomData.map((val) => val - Math.floor(Math.random() * 500)),
    ...
    datasets: [
      {
        ...
        data: randomData.map((val) => val + Math.floor(Math.random() * 1000)),
